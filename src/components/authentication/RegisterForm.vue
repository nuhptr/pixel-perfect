...
const form = ref({ name: "", email: "", password: "", title: "Member" })
...
<template>
   <form>
      ...
      <div class="mt-6">
         <button type="button" @click="register" v-if="form.name && form.email && form.password"
         ...
         <RouterLink to="/login" type="button"
            class="inline-flex items-center justify-center w-full px-8 py-3 mt-2 text-base font-medium text-black bg-gray-200 border border-transparent rounded-full hover:bg-gray-300 md:py-2 md:text-lg md:px-10">
            Sign In
         </RouterLink>
      </div>
   </form>
