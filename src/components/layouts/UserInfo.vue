...
<template>
   <div class="md:order-2">
      <div class="flex items-center">
         <div class="mr-3 text-sm font-regular">Halo, {{ user.name }}</div>
         <button type="button"
            class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 md:items-end focus:ring-4 focus:ring-gray-300"
      ...
      <div class="fixed z-50 my-4 text-base list-none bg-gray-700 divide-y divide-gray-600 rounded" id="dropdown"
         :class="{ hidden: !show }">
         <div class="px-4 py-3">
